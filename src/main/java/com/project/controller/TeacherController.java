...
public class TeacherController {
  ...
  public Mono<ResponseEntity<Flux<Teacher>>> findAll() {
    return Mono
    .just(ResponseEntity.ok().contentType(MediaType.APPLICATION_JSON_UTF8)
    .body(teacherService.findAll()));
  }

  /**
  * . method to search teacher by id
  */
  ...
  */
  ...
  public Mono<ResponseEntity<Map<String, Object>>> create(
      @Valid @RequestBody Mono<Teacher> teacherMono) {
  ...
  */
  @PutMapping("/{id}")
  public Mono<ResponseEntity<Teacher>> save(
      @RequestBody Teacher teacher, @PathVariable String idTeacher) {
